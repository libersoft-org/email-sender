...
async function start() {
 ...
 const sql = [
  ...
  'CREATE TABLE IF NOT EXISTS servers (id INT PRIMARY KEY AUTO_INCREMENT, server VARCHAR(128) NOT NULL, port INT NOT NULL DEFAULT 25, secure BOOL NOT NULL DEFAULT 0, auth_user VARCHAR(64) NULL, auth_pass VARCHAR(64) NULL, email VARCHAR(128) NOT NULL, link VARCHAR(128) NULL, footer TEXT NULL, created TIMESTAMP DEFAULT CURRENT_TIMESTAMP())',
  'CREATE TABLE IF NOT EXISTS campaigns (id INT PRIMARY KEY AUTO_INCREMENT, name VARCHAR(128) NULL, id_server INT NOT NULL, visible_name VARCHAR(255) NULL, subject TEXT NULL, body TEXT NULL, created TIMESTAMP DEFAULT CURRENT_TIMESTAMP(), FOREIGN KEY (id_server) REFERENCES servers(id))',
